...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pushpa Online Tuition — International Online Tutors" },
      { name: "description", content: "Personalised online tutoring for Year 2 to A-Level students across UK, Cambridge IGCSE, UAE, Switzerland and German international curricula." },
      { name: "author", content: "Pushpa Online Tuition" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Pushpa Online Tuition",
          url: "https://www.pushpaedu.com",
          email: "info@pushpaedu.com",
          telephone: "+91 89395 77588",
          description: "International online tutoring for Year 2 to A-Level students.",
        }),
      },
    ],
  }),
